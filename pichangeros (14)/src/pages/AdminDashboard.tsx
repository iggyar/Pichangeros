...
import { LogOut, Trophy, Users, MapPin, CalendarDays, DollarSign, ShieldAlert, Settings, CheckCircle2, XCircle, Eye, Shield, Activity, AlertCircle, Search as SearchIcon, Filter, Trash2 } from "lucide-react";
...
export default function AdminDashboard() {
  ...
  const isAdmin = user?.email?.toLowerCase() === "iggy666thepro@gmail.com";
            ...
            <div className="space-y-6">
                      ...
                      {manualPayments.map((p) => {
                        ...
                        return (
                          <tr key={p.id} className="odd:bg-white even:bg-slate-50/50 hover:bg-emerald-50/10 transition-colors">
                            ...
                            <td className="px-6 py-5 font-mono text-xs font-bold text-blue-600">{p.codigoOperacionYape || p.codigoYape || "N/A"}</td>
              ...
              <Dialog open={isPaymentDetailOpen} onOpenChange={setIsPaymentDetailOpen}>
                <DialogContent className="sm:max-w-md rounded-2xl">
                  ...
                  {selectedPayment && (() => {
                    const isReadyToPay = selectedPayment.status === "Llegó a la cancha" || selectedPayment.arrivalConfirmed || selectedPayment.paymentStatus === "released";
                    const ownerPayout = (selectedPayment.price || selectedPayment.montoTotal || 0) * 0.9;
                    return (
                      <div className="space-y-4 pt-2">
                        ...
                        <div className="border-t border-slate-100 pt-4 mt-2">
                          <p className="text-xs font-bold text-slate-950 uppercase mb-3">Liquidación a Dueño (Comisión 10%)</p>
                          <div className="bg-slate-50 p-4 rounded-xl border border-slate-100 space-y-2">
                            <div className="flex justify-between items-center text-sm">
                              <span className="text-slate-500">Monto a pagar al dueño (90%):</span>
                        ...
                        {selectedPayment.estadoPago === "Pago confirmado" && !selectedPayment.pagoAlDueno && (
                          <div className="pt-2">
                            <Button 
                              className="w-full bg-blue-600 hover:bg-blue-700 text-white font-bold h-11 rounded-xl shadow-md border-none"
                              onClick={async () => {
