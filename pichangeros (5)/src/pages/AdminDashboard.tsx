...
export default function AdminDashboard() {
  ...
  useEffect(() => {
    ...
    if (!user || (!isAdminEmail && profile?.role !== "admin")) {
      navigate("/dashboard");
      return;
    }
    
    setLoading(false);
  }, [user, profile, authLoading, navigate, isAdminEmail]);

  useEffect(() => {
    if (!isAdminEmail && profile?.role !== "admin") return;
