            ...
            <Card className="border-slate-200 shadow-xl shadow-slate-200/50 rounded-3xl overflow-hidden">
              ...
              <div className="p-3 space-y-1">
                ...
                <Button 
                  variant="outline" 
                  onClick={switchRole}
                  className="w-full justify-start rounded-xl h-12 border-green-200 text-green-700 hover:bg-green-50 mb-2"
                >
                ...
                <Button 
                  ...
                  onClick={async () => {
                    ...
                    try {
                      ...
                      toast.success("Cambiando a vista de Administrador...");
                      navigate("/admin");
                    } catch (error) {
                      toast.error("Error al cambiar de vista");
                    }
                  }}
                  className="w-full justify-start rounded-xl h-12 border-purple-200 text-purple-700 hover:bg-purple-50"
                >
